...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const tiltEngine = useMemo<TiltEngine | null>(() => {
    ...
    const step = (ts: number): void => {
      ...
      const itemsTau = ts < initialUntil ? INITIAL_TAU : DEFAULT_TAU;
      const k = 1 - Math.exp(-dt / itemsTau);
      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            >
              <div className="w-full absolute flex flex-col bottom-[20px]" style={{ display: 'flex', gridArea: 'auto' }}>
                <h3
                  className="font-bold m-0 text-shadow-sm"
                  style={{
                    fontSize: '1.5rem',
                    color: '#ffffff',
                ...
                <p
                  className="font-medium whitespace-nowrap mx-auto text-shadow-sm"
                  style={{
                    fontSize: '0.875rem',
